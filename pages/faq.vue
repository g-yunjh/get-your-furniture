...
const sections: FaqSection[] = [
  {
    title: '가구 판매와 등록',
    items: [
      { q: 'Q1. 가구 등록은 누구나 할 수 있나요?', a: 'A1. 네, 회원가입 후 누구나 사진과 정보를 입력해 쉽게 가구를 등록할 수 있습니다.' },
      { q: 'Q2. 상태가 좋지 않은 가구도 등록할 수 있나요?', a: 'A2. 가능합니다. 다만 가구 상태를 ‘등급’으로 표시하여 구매자가 선택할 수 있도록 합니다.' },
      { q: 'Q3. 가격은 어떻게 정하나요?', a: 'A3. 판매자가 직접 가격을 입력합니다. 필요하면 가져가구에게 평가 받으실 수도 있습니다.' },
    ],
  },
  {
    title: '구매와 결제',
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Q2. 배송비는 어떻게 정해지나요?', a: 'A2. 거리와 가구 크기에 따라 산정됩니다. 직영 라이더는 자동산정, 일반 라이더는 직접 연락 후 결정됩니다.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Q2. 가져가구는 무료인가요?', a: 'A2. 가구 등록과 둘러보기는 무료입니다. 거래가 성사되면 수수료와 배송비가 발생합니다.' },
    ],
  },
]
